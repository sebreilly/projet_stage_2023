...
- Tester les machines.
### Projet réalisé
Je n'ai réalisé aucun projet étant donné que j'achève mon passage chez Solotech. Ceci dit je compte refaire la captation de la voix off du montage et leur renvoyer un produit fini.
### Dynamique du stage
Les employés avec qui j'ai eu la chance de travailler sont autant déçu que moi de la tournure qu'a prit mon stage. Certains ont même envisagés de parler en mon nom, mais cela n'aurais rien changé à la situation. Ils m'ont également proposé un poste, mais celui-ci est dérisoire pour un finissant de Techniques. j'ai donc naturellement décliné l'offre. Je suis reconnaissant tout de même à Solotech de m'avoir formé en tant que technicien LX. Je suis également reconnaissant de l'opportunité que Solotech m'a offert en tant que stagiaire, mais je ne recommanderais pas Sololtech pour de futurs finissants en techniques d'intégration multimédia à moins d'une meilleure planification des stages et une meilleure communication avec le département des ressources humaines. 
