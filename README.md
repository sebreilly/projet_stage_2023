...
### Dynamique du stage
Mon stage ne se déroulait pas comme dans le mandat initiale, étant donné le manque de clarté au niveau de mes objectifs et de mon rôle dans cette entreprise, mais je crois avoir rectifié ceci. Cela-dit, je m'intègre bien avec les employés et je dispose d'un espace et d'outils adéquats pour effectuer les tâches demandées.
